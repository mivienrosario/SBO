...
<html lang="en" dir="ltr">
  ...
  <body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
      ...
      <div class="w3-bar-block">
        ...
        <?php if ($_SESSION['utype'] != 4): ?>
            <a href="users.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw">  Users </a>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      <div class="w3-container">
		    <ul class="breadcrumb">
			    <li class="breadcrumb-item"><i class="fa fa-user"></i>  Account Settings</li>
          <li class="breadcrumb-item"><?php echo $_SESSION['uname']; ?></li>
        </ul>
      </div>
      ...
      <div class="w3-container  w3-margin-bottom" style="width: 80%; margin-left: 1em;">
        ...
        <div class="w3-container">
          <table class="w3-table w3-bordered">
            <tr>
              <td class="w3-large ">User Type</td>
              <td><?php echo $type; ?></td>
              <td class="w3-center">
                <?php if ($_SESSION['utype'] != 4): ?>
            ...
            <tr>
              <td class="w3-large">Student ID</td>
              <td><?php echo $sId; ?></td>
              <td></td>
            </tr>
            <form class="" action="inc/changepw.inc.php" method="post">
              <input type="hidden" name="username" value="<?php echo $_SESSION['uname'];?>">
              <tr>
                <td class="w3-large">Current Password</td>
                <td> <input type="password" class="w3-input w3-round" name="current-pw" value="<?php echo $password; ?>"> </td>
                <td></td>
              </tr>
              <tr>
                <td class="w3-large">New Password</td>
                <td> <input type="password" class="w3-input w3-round" name="new-pw"> </td>
                <td></td>
              </tr>
              <tr>
                <td class="w3-large">Repeat Password</td>
                <td> <input type="password" class="w3-input w3-round" name="repeat-pw"> </td>
                <td></td>
              </tr>
              <tr>
                <td></td>
                <td></td>
                <td class="w3-center">
                  <button type="submit" class="w3-btn w3-blue w3-round" name="pw-submit">Save Password</button>
                </td>
              </tr>
            </form>
