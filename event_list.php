...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="main-wrapper">
      <div class="sidenav w3-flat-turquoise">
        <?php
          include 'sidenav.php';
        ?>
      </div>
      <div class="content-wrapper">
        <!-- breadcrumb here -->
        <ul class="breadcrumb w3-flat-turquoise">
        ...
        $display = "'block'";
          if($_SESSION['utype'] != 3) {
            echo '<button onclick="document.getElementById('. $modalId .').style.display='. $display .'" class="w3-button w3-black float-right w3-margin-bottom">Add New Event</button>';
          }
