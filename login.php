    ...
    <div class="container">
      <div class="">
        <form action="inc/login.inc.php" method="post">
          <h1>Login</h1>
            <input type="text" name="username" placeholder="Username" class="bc-input">
            <input type="password" name="pw" placeholder="Password" class="bc-input">
            <br>
            <button type="submit" name="login" class="bc-btn">Sign In</button>
