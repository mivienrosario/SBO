...
CREATE TABLE `attendance` (
  ...
  `am_in_start` time DEFAULT NULL,
  `am_in_end` time DEFAULT NULL,
  `am_out_start` time DEFAULT NULL,
  `am_out_end` time DEFAULT NULL,
  `pm_instart` time DEFAULT NULL,
  `pm_inend` time DEFAULT NULL,
  `pm_outstart` time DEFAULT NULL,
  `pm_outend` time DEFAULT NULL,
...
INSERT INTO `attendance` VALUES (1,3,'2019-12-11','08:30:00','09:00:00','03:00:00','03:30:00',NULL,NULL,NULL,NULL),(2,3,'2019-12-12','00:00:00','23:59:00','00:00:00','23:59:00','00:00:00','23:59:00','00:00:00','23:59:00');
...
INSERT INTO `student` VALUES ('131-4578-1','Khan','Gengis','Mongol','Mongol','9081239874',2),('142-1324-1','Ruiz','Ameerah','Garcia','87 Bonifcio Drive, Victoria Village ','63-2-9847589',2),('151-1547-4','de la Cruz','Juan','Garcia','San Fernando, La Union','09123941234',2),('171-0115-2','Francisco','Rica','Oafericua','San Fernando City','09121117780',1),('171-0135-2','dabatos','christian','balahay','san francisco','09957695761',1),('171-0192-2','Rosario','Mivien','Alvar','400 Cantingan, Quinavite, Bauang, La Union','09219698035',3);
