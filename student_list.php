    ...
    <div class="main-wrapper">
      ...
      &nbsp;
        ...
        //checks if the user's type is not student
          if($_SESSION['utype'] != 3) {
            echo '<button onclick="document.getElementById('. $modalId .').style.display='. $display .'" class="w3-button w3-black float-right w3-margin-bottom">Register New Student</button>';
          }
        ?>
